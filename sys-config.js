...
module.exports = {
    app: "test",
    appVersion: "v.2.6.1_20180827", //版本号
    debug: true,
    port: 9530,
    isProduction: isProduction,
    isDevelop: isDevelop,//isDevelop
    ...
    domains: {
        api: "http://192.168.1.200:8088/misrobot-service/",
        edmsApi: "http://192.168.1.200:8088/misrobot-edms/",
        bigdataApi: "http://192.168.1.200:7777/misrobot-bigdata/",
        timeout: 16000 //访问业务层接口超时时间 默认16s
    },
    redisOptions: {
        host: "127.0.0.1",
        port: 6379
    ...
    auth: {
        weixin: {
            ...
            redirect_uri:
                "http://misinfo.misrobot.com/passport/auth/weixin/callback"
        }
    },
    fdfs: {
        enable: true,
    ...
    blastApi: "http://172.16.110.34:8080/misrobot-service/", //大数据ip
